...
export const imageBatDongSan = require('./bat_dong_san.png')
export const imageDoTu = require('./do_dien_tu.png')
export const imageXeCo = require('./xe_co.png')
export const iconHome = require('./icon_home_active.png')
export const iconHomeLine = require('./icon_home.png')
export const iconPost = require('./icon_post_active.png')
export const iconPostLine = require('./icon_post.png')
export const iconHelp = require('./help_active.png')
